...
1.Connect the flip-flops in cascade.

2.Apply the serial data input to the first flip-flop.

3.Provide a common clock signal to all flip-flops.

4.Apply clock pulses continuously.

5.Observe the serial output after each clock pulse.
